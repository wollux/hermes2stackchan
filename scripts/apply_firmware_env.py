...
STRING_KEYS = {
    ...
    "H2S_BRIDGE_AUDIO_URL": "CONFIG_STACKCHAN_BRIDGE_AUDIO_URL",
    "H2S_WAKEWORD_LABEL": "CONFIG_STACKCHAN_WAKEWORD_LABEL",
    "H2S_WAKEWORD_MODEL_HINT": "CONFIG_STACKCHAN_WAKEWORD_MODEL_HINT",
